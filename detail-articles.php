            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="page-section"  style="background-color: white">
                        <div class="head2">
                            <h3><b class="text-blue">Titre de  L'actualité</b></h3>
                        </div>
                        ...
                        <div class="search-form-contaner">
                            <div class="blog-post">
                                ...
                                <div class="blog-single">
                                    <div class="post-info">
                                        <?php echo afficher_date('2017-09-22 07:00') ?> par Ange
                                    </div>
<div>
    <p>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam neque tempora
        odit atque repellat est molestiae perferendis.Nemo enim ipsam voluptatem quia
    ...
    <p>
        Lesed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
        minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
        commodo consequat. Duis aute irure dolor in repreh. Excepteur sint occaecat
        cupidatat non proident, sunt in culpa qui officia deserunt incididunt ut labore
        et d mollit anim id est laborum.
    </p>
